...
module.exports = { 
    ...
    run: async (client, message, args, user, language, prefix) => {
        ...
        const embeded = new MessageEmbed()
            .setAuthor({ name: player.playing ? `${client.i18n.get(language, "music", "np_title")}` : `${client.i18n.get(language, "music", "np_title_pause")}`, iconURL: `https://emoji.gg/assets/emoji/5298-diamond-10.gif` })
